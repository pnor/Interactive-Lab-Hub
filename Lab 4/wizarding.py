...
def draw_arrow(xpos, ypos):
    oled.pixel(xpos, ypos, 1)
    oled.pixel(xpos, ypos + 1, 1)
    oled.pixel(xpos, ypos + 2, 1)
    oled.pixel(xpos, ypos + 3, 1)
    oled.pixel(xpos, ypos + 4, 1)
    oled.pixel(xpos, ypos + 5, 1)
    oled.pixel(xpos, ypos + 6, 1)
